...
<div class="container">
    <header>
        <s:if test="#session.username != null">
            <h5 style="float:right;">Welcome Back! <s:property value="#session.username"></s:property>&emsp;<a
                    href="logout.action">log out</a></h5><br>
        </s:if>
        <s:else>
                ...
                <div class="span7">
                    <form action="modifyUserInfo" class="form-horizontal" method="post">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="username" id="inputName" placeholder="ID"
